...
export const EditUserForm = ({
  ...
  const onSubmit = async (formData: UpdateUser) => {
    const res = await updateUserAction(formData, userId);
  ...
  return (
    <Card className="w-full max-w-xl mx-auto">
      <CardHeader>
        <CardTitle className="text-xl font-bold">Editar usuario</CardTitle>
        <CardDescription>Cambia cualquier campo del usuario.</CardDescription>
      </CardHeader>
      <CardContent>
        ...
        <Field orientation={"horizontal"}>
          ...
          >
            {form.formState.isSubmitting
              ...
              : "Actualizar datos del usuario usuario"}
          </Button>
        </Field>
      </CardFooter>
    </Card>
